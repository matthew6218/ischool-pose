...
Teachable Machine TensorFlow.js pose model.

## Train and export the model

1. Create a **Pose Project** in Teachable Machine.
...
starts a 1.8-second cooldown so a single pose does not trigger many rounds.
...
pose model because that is the runtime format supplied by Teachable Machine.
